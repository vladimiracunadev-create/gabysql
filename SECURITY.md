...
|---|---|---|
| `0.1.x` (último binario en `main`) | soportada | `VERSION = 33` (P4 / 2026-06-10 — column stats persistidas, ver ADR-0068) |
| `0.1.x` previos | sin soporte de seguridad | `VERSION = 1` a `32` (cada bump rechaza explícitamente las DBs anteriores; ver [COMPATIBILITY.md §5](COMPATIBILITY.md#5--formato-en-disco)) |
