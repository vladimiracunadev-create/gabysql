...
| :--- | :--- | :--- |
| `31` | 🟢 Actual | Bloque Z1f (2026-05-29). Corte semántico tras el `same_slice_extra` partial fix de Argon2id. Output del Argon2id cambia significativamente pero **aún no matchea RFC 9106 §A.3** — Z1g pendiente. Default sigue siendo scrypt (Z1c, scheme=2). VERSION 31 puro corte de incompatibilidad — sin nuevo on-disk field (ADR-0061). Rechaza VERSION 30 con `[GBY-1003]`. |
